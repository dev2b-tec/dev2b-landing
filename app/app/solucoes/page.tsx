...
export default function SolucoesPage() {
  return (
    <main>
      ...
      {/* Notas Fiscais */}
      <section id="notas" className="py-16 bg-[#0D0520] scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="rounded-2xl border border-[#7C4DFF]/15 bg-[#120328]/50 p-10 flex flex-col sm:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <h2 className="text-2xl font-black text-white mt-1 mb-2">Emissao de Notas Fiscais integrada</h2>
