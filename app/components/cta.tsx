  ...
  return (
    <section className="py-20 lg:py-28 bg-[var(--d2b-bg-surface)] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[var(--d2b-text-primary)] text-balance mb-6 leading-[1.08]">
        ...
        <p className="text-[var(--d2b-text-secondary)] text-lg max-w-2xl mx-auto mb-10 text-pretty leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            href="/solucoes"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl border border-[#7C4DFF]/40 text-[var(--d2b-brand-light)] font-semibold hover:bg-[#7C4DFF]/10 hover:text-[var(--d2b-text-primary)] transition-all duration-200"
          >
            Ver solucoes
          </Link>
        </div>

        <p className="mt-6 text-[var(--d2b-text-faint)] text-sm">
