...
export default function Blog() {
  return (
    <section id="blog" className="py-20 lg:py-28 bg-[#0D0520]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {posts.map((post) => (
            <Link
              key={post.title}
              href={post.href}
              className="group flex flex-col rounded-2xl overflow-hidden border border-[#7C4DFF]/12 bg-[#120328]/50 hover:border-[#7C4DFF]/40 hover:shadow-xl hover:shadow-[#7C4DFF]/10 hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <h3 className="font-bold text-white text-base leading-snug mb-3 group-hover:text-[#C084FC] transition-colors text-balance">
                  {post.title}
                </h3>
